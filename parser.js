...
const htmlTagsTestCase = {
    ...
    extraParams: [['html', 'body', 'title', 'div', 'h3', 'p']]
};
...
const htmlAttributesTestCase = {
    ...
    extraParams: [[
        { tag: 'div', attribute: 'class', value: 'card' }
    ]]
};
